...
<tr>
    ...
    <td>
        Кому: <b><?=Role::getRole($model->target)?></b>
    </td>
    <td><?php
    ...
    <td>
        <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
                <li><a href="#" class="activator" data-action="/delegate-task/<?=$taskItem->id?>">Назначить исполнителя</a></li>
                <li><a href="#" class="activator" data-action="/change-task-target/<?=$taskItem->id?>">Сменить подразделение</a></li>
                <li class="divider"></li>
                <li><a class="activator" data-action="/delete-task/<?=$taskItem->id?>">Удалить задачу</a>
                </li>
            </ul>
        </div>
    </td>
